ig.module(
    ...
    .defines(function () {
         ...
         **/
        ig.gui.Animation = ig.gui.Core.extend({
            type: 'animation',
            started: false,
            animation: null,
            stopped: true,
            ...
            init: function (styles, duration, callbackStart, callbackComplete, onUpdate, onDraw, element) {
                var that;
                ...
                this.onComplete = callbackComplete || function () {
            ...
            stop: function () {
                ig.gui.redraw(ig.gui.canvas);
                return this;
            },
            remove: function () {
                delete this.element.animation;
                this.element.animation = null;
                return this;
            },
            update: function () {
                var that;
                ...
                _.each(this.stylesToApply, function (v, k) {
                    that.element.style[k] = that.element.styleParsed[k] = that.easingFunctions[that.easing](null, that.timer.delta(), that.startValues[k], that.values[k], that.duration);
